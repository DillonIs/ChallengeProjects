...
# Load your .env file using full path
load_dotenv("/root/ChallengeProjects/SecureTaskManagement/Backend/.env")

# Add your app folder to sys.path so you can import models
sys.path.append("/root/ChallengeProjects/SecureTaskManagement/Backend/app")
